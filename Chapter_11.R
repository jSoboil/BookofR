...
arrows(x0 = 7, y0 = 5000, x1 = 11.3, y1 = 1300)
arrows(x0 = 8.2, y0 = 5800, x1 = 18, y1 = 4100)
...
# Note: have not completed final exercises as they are relatively basic and intuitive.
# End file ----------------------------------------------------------------